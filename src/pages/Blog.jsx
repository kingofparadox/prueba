                    ...
                    <div className="card text-light shadow-lg border-secondary p-4 p-md-5" style={{ backgroundColor: '#86997eff' }}>
                        ...
                        <section id="casos-exito" className="mb-5 pt-3">
                            ...
                            <div className="card bg-dark text-light border-secondary p-4 mb-3">
                                <h5 className="text-white fw-bold">"La vitrina de Carlos: De una figura a una colección épica"</h5>
                                <p className="text-white-50 small mb-2">Cliente desde 2024</p>
                            ...
                            <div className="card bg-dark text-light border-secondary p-4">
                                <h5 className="text-white fw-bold">"El rincón otaku de Valentina y su set de coleccionista"</h5>
                                <p className="text-white-50 small mb-2">Cliente desde 2025</p>
                                <p className="text-white-50 mb-0">
                        ...
                        <section id="preguntas-frecuentes" className="pt-3">
                            ...
                            <div className="mb-4">
                                <h5 className="text-white fw-bold fs-6">¿Las figuras y productos son 100% originales?</h5>
                            ...
                            <div className="mb-4">
                                <h5 className="text-white fw-bold fs-6">¿Cómo se realizan los envíos a regiones?</h5>
                                <p className="text-white-50">
                            ...
                            <div className="mb-4">
                                <h5 className="text-white fw-bold fs-6">¿Qué dominios aceptan para registrarse?</h5>
                                <p className="text-white-50">
