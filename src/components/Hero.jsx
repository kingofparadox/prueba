      ...
      <div className="container-fluid py-3">
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 mb-4 mb-lg-0">
            ...
            {/* Aquí usamos Link apuntando a la ruta de productos (/Ventas según tu App.jsx) */}
            <Link to="/Ventas" className="btn btn-light btn-lg px-4 fw-bold text-dark shadow-sm">
              Ver productos
            </Link>
          </div>
          ...
          <div className="col-lg-6">
            ...
            style={{ backgroundColor: '#1a1025', minHeight: '220px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
